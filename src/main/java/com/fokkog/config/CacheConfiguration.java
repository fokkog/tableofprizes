...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.fokkog.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.fokkog.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.fokkog.domain.User.class.getName());
            ...
            createCache(cm, com.fokkog.domain.Prize.class.getName());
